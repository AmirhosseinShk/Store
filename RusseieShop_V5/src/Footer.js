    ...
    <div className="MainFooter">
      <div className="row">
        ...
        <div class="col-sm-auto" id="SpaceFooters">
          <spam class="headerOfFooter">товар</spam>
          <br class="line" />
        ...
        <div class="col-sm-auto" id="SpaceFooters">
          <spam class="headerOfFooter">насчет нас</spam>
          <br class="line" />
          <Link
            to={{ pathname: "/AboutUs" }}
        ...
        <div class="col-sm-auto" id="SpaceFooters">
          <spam class="headerOfFooter">Поддержка</spam>
          <br class="line" />
          <a href="#" class="ItemFooter deleteUnderLink">
            условия
          </a>
        ...
        <div class="col-sm-auto" id="SpaceFooters">
          <spam class="headerOfFooter">оплата</spam>
          <br class="line" />
          <a href="#" class="ItemFooter deleteUnderLink">
            Visa
          </a>
