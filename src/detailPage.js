...
class detail extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            specifaction: [{ x: 'test', y: 'test' }, { x: 'test', y: 'test' }, { x: 'test', y: 'test' }, { x: 'test', y: 'test' }],
            ItemShop: [{ name: 'test', price: '75.000$' }, { name: 'test', price: '75.000$' }, { name: 'test', price: '75.000$' }, { name: 'test', price: '75.000$' }],
            totalprice: 0.0 ,
            deleteElement:[]
    ...
    changIcon() {
        ...
        if (classname[1] == "fa-plus") {
            ...
            document.getElementById("shopCardButton").style.background = 'rgb(255,0,94)';
            document.getElementById('NewItem').setAttribute('class', 'fa fa-circle fa-xs')
        }
        else {
    ...
    openNav() {
        ...
        if (selectRadio == 'cash') {
            ...
            document.getElementById("priceDetail").setAttribute('class', 'shadowbackground');
        }
    ...
    OpenPayPage() {
        ...
        if (selectRadio == 'cash') {
            ...
            document.getElementById("Order").setAttribute('class', 'shadowbackground');
        }
            ...
            <div>
                    ...
                    <div class="row ">
                        <div class="col-4 ">
                            <div class="shopCard producePhoto">
                                <button className="ml-auto mr-3" id="shopCardButton" onClick={this.changIcon}>
                        ...
                        <div class="col-4 productText">
                            ...
                            <div class="setSize">
                                ...
                                <select class="selectBox">
                                    ...
                                    <option selected value="coconut">80*10 m</option>
                        ...
                        <div class="col-4  cardMargin">
                            <div class="shopCard payment">
                                ...
                                <div className="row">
                                    ...
                                    <form class="checkbox" >
                                        <input class="radioBox radioMaster" type="radio" name="PaymentMethods" value="Master-card" />
                                        <label for="Master-card"> Master-card</label>
                                        <br />
                                        <input class="radioBox radioMaster" type="radio" name="PaymentMethods" value="paypal" />
                                        <label for="Paypal"> Paypal</label>
                                        <br /><input class="radioBox radioMaster" type="radio" name="PaymentMethods" value="visa" />
                                        <label for="Visa"> Master-card</label>
                                        <br /><input class="radioBox radioMaster" type="radio" name="PaymentMethods" value="cash" />
                                        <label for="Master-card"> Master-card</label>
                                        <br />
                                    </form>
                                </div>
                                <button class="button_price" onClick={this.openNav} >price detail</button>
                                <br />
                                <button class="button_order" onClick={this.OpenPayPage} > order</button>
                            </div>
                        </div>
                ...
                <div id="Order">
                    <div id="deletesection">
                        ...
                        <span class="price"> {this.state.totalprice} $</span>
                        <br />
                        <button class="pay" onClick={this.RegisterForm}>Pay now</button>
                    </div>
                </div>
                ...
                <i class="closebtn fa fa-times fa-2x" onClick={this.closeOrder}></i>
                    ...
                    <h6 for="Name">Name</h6>
                    <input class="inputs" type="text" placeholder="Enter Name" name="Name" id="Name" required />
                    <br/>
                    ...
                    <input class="inputs" type="text" placeholder="Contact Number" name="number" id="number" required />
                    <br/>
                    <h6 for="address">َAddress</h6>
                    <textarea  class=" inputsAddress" type="text" placeholder="Address" name="address" id="address" required />
                    </form>
                </div>
            </div>
        );
