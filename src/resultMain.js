        ...
        return (
            <div class="main">
                ...
                { test ? (
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="addPrice">
                                    ...
                                    <br/>
                                    <input type="range" class="test setradioxleft" min="0" max="60.000" step="1" id="customRange3" />
                                    <input type="range" class="test setradioxright" min="61.000" max="100.000" step="1" id="customRange3" />
                                    <span class='min'>0 ₽</span>
                                    <span class="max">60.000 ₽</span>
                                    <button class="priceSubmit" onClick={this.ResultOfRangeButton}> submit</button>
                                </div>
                            </div>
                            <div class='col-8'>
                                {showresult ? (
                                <div>
                                        ...
                                        {this.state.items.map((item) => (
                                            <div className="col-md-4 cardMarginResult ">
                                                <div class="shopCardResult">
                                                    ...
                                                    <img id="shopCardResultImage" src={item.src}></img>
                                                    <div className="row shopCardResultRow">
                                                        <span id="shopCardResultPrice">{item.price}</span>
                                                        <button className="ml-auto mr-3" id="shopCardResultButton">
                                    ...
                                    <ul class="pagination">
                                      ...
                                      <li class="page-item">
                                        ...
                                        <div>
                                            <img class="rangebuttonimg" src={noResult} heigh="300" width="250"></img>
                    ...
                    : (
                        <div>
                            <img class="noresultimg" src={noResult} heigh="300" width="250"></img>
